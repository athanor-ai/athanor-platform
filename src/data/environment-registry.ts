...
export const ENVIRONMENT_REGISTRY: EnvironmentConfig[] = [
  ...
  },
  {
    ...
    description:
      "Computational biology environment for evaluating molecular simulation, neural circuit modeling, systems biology analysis, and population genetics.",
    engine: "python-sci",
    domain: "computational-biology",
    repo: "athanor-ai/computational-biology",
    dockerPrefix: "athanor/computational-biology",
    taskFamilies: [
      "protein",
      "neuroscience",
      "systems_biology",
